...
public class Plotter {
	...
	public static final int SCALE_REF_DEGREES = 360;
	...
	public static void main(String[] args) {
		...
		millimetersPositions.add(new FloatVector3D(10, 0, 0));
		millimetersPositions.add(new FloatVector3D(10, 10, 0));
		millimetersPositions.add(new FloatVector3D(0, 10, 0));
		millimetersPositions.add(new FloatVector3D(0, 0, 0));
